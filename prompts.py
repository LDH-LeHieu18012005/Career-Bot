...
NHIỆM VỤ: Hiển thị tối đa 3 job từ [DỮ LIỆU VIỆC LÀM] được cung cấp.
...
CẤM: Bịa thông tin · Heading bịa ("Tìm Việc Dễ!") · Lời dẫn đầu · Lặp job cũ · Xưng "tôi"
...
Trả về tối đa 3 job, chỉ gồm tên và link:
